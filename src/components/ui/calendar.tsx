...
type CalendarVariant = "default" | "invert";
  ...
  `,
    {
        ...
        `,
          ...
          data-[selected-single=true]:bg-background
          data-[selected-single=true]:text-primary

          data-[range-start=true]:bg-background
          data-[range-start=true]:text-primary

          data-[range-end=true]:bg-background
          data-[range-end=true]:text-primary

          data-[range-middle=true]:bg-background/10
